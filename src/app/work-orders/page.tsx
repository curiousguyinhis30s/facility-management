      ...
      <div className="grid gap-6 md:grid-cols-4 mb-6">
        <Card>
          <CardContent className="p-6">
            ...
            <div className="mt-2 text-3xl font-semibold text-gray-900">{stats.open}</div>
            <div className="mt-2 text-sm text-gray-500">Pending assignment</div>
          </CardContent>
        </Card>
          ...
          <Card>
            <CardContent className="p-12">
              <div className="flex flex-col items-center justify-center">
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900">No work orders found</h3>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="font-medium text-gray-900">{wo.property}</div>
                        <div className="text-gray-500">{wo.unit}</div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className="font-medium text-gray-900">{wo.assignedTo || 'Unassigned'}</div>
                      </div>
                      <div>
                        <div className="text-gray-500">Reported By</div>
                        <div className="font-medium text-gray-900">{wo.reportedBy}</div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className={`font-medium ${wo.priority === 'urgent' ? 'text-danger' : 'text-gray-900'}`}>
