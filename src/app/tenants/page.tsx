      ...
      <div className="flex flex-wrap items-center gap-6 mb-4 pb-4 border-b border-black/[0.06]">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] text-black/50">Total Tenants</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-semibold text-green-600">{tenants.filter((t) => t.status === 'active').length}</div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-semibold text-amber-600">{tenants.filter((t) => t.status === 'pending').length}</div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-semibold text-red-600">{formatCurrency(tenants.filter((t) => t.balance > 0).reduce((sum, t) => sum + t.balance, 0))}</div>
            <div className="text-[11px] text-black/50">Outstanding</div>
          </div>
        </div>
      </div>
