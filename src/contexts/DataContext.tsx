...
const mockProperties: Property[] = [
  {
    ...
    description: 'Modern apartment complex with resort-style amenities',
    amenities: ['Pool', 'Gym', 'Parking', 'Laundry', 'BBQ Area'],
    yearBuilt: 2018,
    squareFootage: 45000,
    parkingSpaces: 48,
  ...
  },
  {
    ...
    description: 'Luxury condominiums in the heart of downtown',
    amenities: ['Concierge', 'Rooftop', 'Gym', 'Underground Parking'],
    yearBuilt: 2020,
    squareFootage: 32000,
    parkingSpaces: 36,
  ...
  },
  {
    ...
    description: 'Industrial warehouse space for commercial use',
    amenities: ['Loading Docks', '24/7 Access', 'Security'],
    yearBuilt: 2015,
    squareFootage: 80000,
    parkingSpaces: 20,
  ...
  },
  {
    ...
    description: 'Charming single-family homes with private gardens',
    amenities: ['Private Garden', 'Garage', 'Patio'],
    yearBuilt: 2010,
    squareFootage: 12000,
    parkingSpaces: 12,
...
const mockUnits: Unit[] = [
  { id: 'unit-1', propertyId: 'prop-1', unitNumber: '101', floor: 1, type: '1br', squareFootage: 750, bedrooms: 1, bathrooms: 1, monthlyRent: 2200, status: 'occupied' },
  { id: 'unit-2', propertyId: 'prop-1', unitNumber: '102', floor: 1, type: '1br', squareFootage: 750, bedrooms: 1, bathrooms: 1, monthlyRent: 1500, status: 'occupied' },
  { id: 'unit-3', propertyId: 'prop-1', unitNumber: '103', floor: 1, type: '2br', squareFootage: 1000, bedrooms: 2, bathrooms: 2, monthlyRent: 2400, status: 'available' },
  { id: 'unit-4', propertyId: 'prop-1', unitNumber: '104', floor: 1, type: '2br', squareFootage: 1000, bedrooms: 2, bathrooms: 2, monthlyRent: 2200, status: 'occupied' },
  { id: 'unit-5', propertyId: 'prop-2', unitNumber: '305', floor: 3, type: '2br', squareFootage: 1200, bedrooms: 2, bathrooms: 2, monthlyRent: 3200, status: 'occupied' },
  { id: 'unit-6', propertyId: 'prop-4', unitNumber: '1A', floor: 1, type: '3br', squareFootage: 1800, bedrooms: 3, bathrooms: 2, monthlyRent: 2800, status: 'occupied' },
]
