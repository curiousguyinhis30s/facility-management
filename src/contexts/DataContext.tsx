...
const mockUnits: Unit[] = [
  // Sunset Apartments - prop-1 (32 units total, showing 8)
  { id: 'unit-1', propertyId: 'prop-1', unitNumber: 'A-101', floor: 1, type: '1br', squareFootage: 750, bedrooms: 1, bathrooms: 1, monthlyRent: 4500, status: 'occupied' },
  { id: 'unit-2', propertyId: 'prop-1', unitNumber: 'A-102', floor: 1, type: '1br', squareFootage: 750, bedrooms: 1, bathrooms: 1, monthlyRent: 4500, status: 'occupied' },
  { id: 'unit-3', propertyId: 'prop-1', unitNumber: 'A-201', floor: 2, type: '2br', squareFootage: 1100, bedrooms: 2, bathrooms: 2, monthlyRent: 6500, status: 'available' },
  { id: 'unit-4', propertyId: 'prop-1', unitNumber: 'A-202', floor: 2, type: '2br', squareFootage: 1100, bedrooms: 2, bathrooms: 2, monthlyRent: 6500, status: 'occupied' },
  { id: 'unit-7', propertyId: 'prop-1', unitNumber: 'A-301', floor: 3, type: 'studio', squareFootage: 550, bedrooms: 0, bathrooms: 1, monthlyRent: 3200, status: 'occupied' },
  { id: 'unit-8', propertyId: 'prop-1', unitNumber: 'A-302', floor: 3, type: 'studio', squareFootage: 550, bedrooms: 0, bathrooms: 1, monthlyRent: 3200, status: 'available' },
  { id: 'unit-9', propertyId: 'prop-1', unitNumber: 'B-101', floor: 1, type: '2br', squareFootage: 1050, bedrooms: 2, bathrooms: 2, monthlyRent: 5800, status: 'occupied' },
  { id: 'unit-10', propertyId: 'prop-1', unitNumber: 'B-201', floor: 2, type: '3br', squareFootage: 1400, bedrooms: 3, bathrooms: 2, monthlyRent: 7500, status: 'occupied' },

  // Harbor View Tower - prop-2 (24 units, showing 6)
  { id: 'unit-5', propertyId: 'prop-2', unitNumber: '1205', floor: 12, type: '3br', squareFootage: 1800, bedrooms: 3, bathrooms: 3, monthlyRent: 9000, status: 'occupied' },
  { id: 'unit-11', propertyId: 'prop-2', unitNumber: '801', floor: 8, type: '2br', squareFootage: 1400, bedrooms: 2, bathrooms: 2, monthlyRent: 7500, status: 'occupied' },
  { id: 'unit-12', propertyId: 'prop-2', unitNumber: '802', floor: 8, type: '2br', squareFootage: 1400, bedrooms: 2, bathrooms: 2, monthlyRent: 7500, status: 'occupied' },
  { id: 'unit-13', propertyId: 'prop-2', unitNumber: 'PH-1', floor: 15, type: '4br', squareFootage: 3200, bedrooms: 4, bathrooms: 4, monthlyRent: 18000, status: 'occupied' },
  { id: 'unit-14', propertyId: 'prop-2', unitNumber: '601', floor: 6, type: '1br', squareFootage: 950, bedrooms: 1, bathrooms: 1, monthlyRent: 5500, status: 'occupied' },
  { id: 'unit-15', propertyId: 'prop-2', unitNumber: '1001', floor: 10, type: '3br', squareFootage: 1900, bedrooms: 3, bathrooms: 2, monthlyRent: 9500, status: 'occupied' },

  // Metro Business Center - prop-3 (12 warehouse units, showing 4)
  { id: 'unit-16', propertyId: 'prop-3', unitNumber: 'W-A1', floor: 1, type: 'commercial', squareFootage: 8000, bedrooms: 0, bathrooms: 1, monthlyRent: 7000, status: 'occupied' },
  { id: 'unit-17', propertyId: 'prop-3', unitNumber: 'W-A2', floor: 1, type: 'commercial', squareFootage: 8000, bedrooms: 0, bathrooms: 1, monthlyRent: 7000, status: 'occupied' },
  { id: 'unit-18', propertyId: 'prop-3', unitNumber: 'W-B1', floor: 1, type: 'storage', squareFootage: 10000, bedrooms: 0, bathrooms: 2, monthlyRent: 8500, status: 'available' },
  { id: 'unit-19', propertyId: 'prop-3', unitNumber: 'W-B2', floor: 1, type: 'storage', squareFootage: 10000, bedrooms: 0, bathrooms: 2, monthlyRent: 8500, status: 'occupied' },

  // Oakwood Villas - prop-4 (8 units, showing 4)
  { id: 'unit-6', propertyId: 'prop-4', unitNumber: 'Villa-3', floor: 1, type: '4br', squareFootage: 3500, bedrooms: 4, bathrooms: 3, monthlyRent: 8000, status: 'occupied' },
  { id: 'unit-20', propertyId: 'prop-4', unitNumber: 'Villa-1', floor: 1, type: '3br', squareFootage: 2800, bedrooms: 3, bathrooms: 2, monthlyRent: 6500, status: 'occupied' },
  { id: 'unit-21', propertyId: 'prop-4', unitNumber: 'Villa-2', floor: 1, type: '3br', squareFootage: 2800, bedrooms: 3, bathrooms: 2, monthlyRent: 6500, status: 'occupied' },
  { id: 'unit-22', propertyId: 'prop-4', unitNumber: 'Villa-4', floor: 1, type: '4br', squareFootage: 4200, bedrooms: 5, bathrooms: 4, monthlyRent: 9500, status: 'available' },
]
...
const mockTenants: Tenant[] = [
  ...
  },
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Jennifer+Brown&background=EC4899&color=fff',
  ...
  },
  {
    ...
    email: 'w.thompson@enterprise.com',
    phone: '(555) 789-0123',
    type: 'individual',
    status: 'active',
    balance: 0,
    moveInDate: new Date('2024-02-15'),
    avatar: 'https://ui-avatars.com/api/?name=William+Thompson&background=6366F1&color=fff',
    createdAt: new Date('2024-02-15'),
    updatedAt: new Date('2024-02-15'),
  },
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Global+Logistics&background=14B8A6&color=fff',
  ...
  },
  {
    ...
    email: 'andersons@gmail.com',
    phone: '(555) 901-2345',
    type: 'individual',
    status: 'active',
    balance: 1200,
    moveInDate: new Date('2024-04-01'),
    avatar: 'https://ui-avatars.com/api/?name=David+Anderson&background=F97316&color=fff',
  ...
  },
  {
    ...
    email: 'sophia.r@outlook.com',
    phone: '(555) 012-3456',
    type: 'individual',
    status: 'active',
    balance: 0,
    moveInDate: new Date('2024-07-15'),
    avatar: 'https://ui-avatars.com/api/?name=Sophia+Rodriguez&background=0EA5E9&color=fff',
