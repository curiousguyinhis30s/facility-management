...
const mockProperties: Property[] = [
  {
    ...
    description: 'Premium residential apartments in the heart of Riyadh business district with modern amenities and excellent accessibility.',
    amenities: ['Swimming Pool', 'Fitness Center', 'Underground Parking', 'Prayer Room', '24/7 Security'],
    yearBuilt: 2021,
    squareFootage: 52000,
    parkingSpaces: 64,
  ...
  },
  {
    ...
    description: 'Luxury waterfront condominiums with stunning Red Sea views and world-class facilities.',
    amenities: ['Sea View', 'Concierge', 'Rooftop Lounge', 'Valet Parking', 'Private Beach Access'],
    yearBuilt: 2022,
    squareFootage: 38000,
    parkingSpaces: 48,
  ...
  {
    id: 'prop-3',
    name: 'Industrial City Warehouse',
    address: 'Second Industrial City, Block 7',
    city: 'Dammam',
    ...
    description: 'Modern logistics and storage facility with excellent connectivity to ports and highways.',
  ...
  {
    id: 'prop-4',
    name: 'Al Nakheel Villas',
    address: 'Al Nakheel District, Zone 3',
    city: 'Riyadh',
    state: 'Riyadh Region',
    zipCode: '12382',
    type: 'house',
    ...
    amenities: ['Private Garden', 'Maid Room', 'Double Garage', 'Central AC', 'BBQ Area'],
    yearBuilt: 2018,
    squareFootage: 24000,
    parkingSpaces: 16,
...
const mockTenants: Tenant[] = [
  {
    ...
    email: 'mohammed.rashidi@gmail.com',
    phone: '+966 50 123 4567',
    type: 'individual',
    status: 'active',
    balance: 0,
    moveInDate: new Date('2024-01-15'),
    avatar: 'https://ui-avatars.com/api/?name=Mohammed+Rashidi&background=2563EB&color=fff',
    createdAt: new Date('2024-01-15'),
    updatedAt: new Date('2024-01-15'),
  },
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Fatima+Zahrani&background=10B981&color=fff',
  ...
  },
  {
    ...
    email: 'abdullah.ghamdi@company.sa',
    phone: '+966 54 345 6789',
    type: 'individual',
    status: 'pending',
    balance: -900,
    avatar: 'https://ui-avatars.com/api/?name=Abdullah+Ghamdi&background=F59E0B&color=fff',
  ...
  },
  {
    ...
    unitId: 'unit-5',
    name: 'Nora Al-Otaibi',
    email: 'nora.otaibi@gmail.com',
    phone: '+966 56 456 7890',
    type: 'individual',
    status: 'active',
    balance: 0,
    moveInDate: new Date('2024-05-01'),
    avatar: 'https://ui-avatars.com/api/?name=Nora+Otaibi&background=8B5CF6&color=fff',
  ...
  },
  {
    ...
    email: 'khalid.harbi@aramco.com',
    phone: '+966 59 567 8901',
    type: 'individual',
    status: 'active',
    balance: 0,
    avatar: 'https://ui-avatars.com/api/?name=Khalid+Harbi&background=EF4444&color=fff',
